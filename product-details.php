...
?>
			...
			<ul class="list-inline list-unstyled">
				...
				<li><a><?php echo htmlentities($rw['subcatname']);?></a></li>
				<li class='active'><a><?php echo htmlentities($rw['pname']);?></a></li>
			</ul>
			<?php }?>
	...
	<div class='container'>
		<div class='row single-product outer-bottom-sm '>
			<div class='col-md-3 sidebar'>
				<div class="sidebar-module-container" style="width:150%; margin-left: -50%; ">


					<!-- ==============================================CATEGORY============================================== -->
<div class="sidebar-widget outer-bottom-xs wow fadeInUp">
	<div style=" background-color:purple;" >
	<h3 class="section-title"style="color:white !important;" >Category</h3></div>
...
?>
					...
					<div class="products">
						...
						<div class="product-info text-left m-t-20">
							<h3 class="name"><a style="color: #c700fc !important;" href="product-details.php?pid=<?php echo htmlentities($rws['id']);?>"><?php echo htmlentities($rws['productName']);?></a></h3>
							<div class="rating rateit-small"></div>

							<div class="product-price">	
								<span class="price"style="color: #c700fc !important;">
					&#8369;<?php echo htmlentities($rws['productPrice']);?>.00
								</span>
									
							    <span class="price-before-discount"style="color: #c700fc !important;">
						...
						<div class="cart clearfix animate-effect">
							<div class="action">
								...
								<div class="add-cart-button btn-group">
									<button class="btn btn-primarys icon" data-toggle="dropdown" type="button">
							...
							<button class="btn btn-primarys" type="button" style="color: white !important;">Add to cart</button></a>
								<?php } else {?>
							<div class="action" style="color: white !important;">Out of Stock!</div>
					<?php } ?>
                ...
                <div class="item">
					...
					<div class='col-sm-6 col-md-7 product-info-block'>
						<div class="product-info">
							<h1 class="name" style="color:purple !important; font-size:20px; font-family:'K2D'"><?php echo htmlentities($row['productName']);?></h1>
...
<?php } ?>
							<div class="stock-container info-container m-t-10">
								<div class="row">
									<div class="col-sm-3">
										<div class="stock-box">
											<span class="label" style="color: #c700fc !important;">Availability :</span>
										</div>	
									</div>
									<div class="col-sm-9">
										<div class="stock-box">
...
<div class="stock-container info-container m-t-10">
								<div class="row">
									<div class="col-sm-3">
										<div class="stock-box">
											<span class="label" style="color: #c700fc !important;">Product Brand :</span>
										</div>	
									</div>
									<div class="col-sm-9">
										<div class="stock-box">
...
<div class="stock-container info-container m-t-10">
								<div class="row">
									<div class="col-sm-3">
										<div class="stock-box">
											<span class="label" style="color: #c700fc !important;">Shipping Charge :</span>
										</div>	
									</div>
									<div class="col-sm-9">
										<div class="stock-box">
											<span class="value" style="color: #c700fc !important;"><?php if($row['shippingCharge']==0)
											{
												echo "Free";
											}
											else
					...
					&#8369;<?php echo htmlentities($row['productPrice']);?></span>
											<span class="price-strike"style="color: #c700fc !important;">
					&#8369;<?php echo htmlentities($row['productPriceBeforeDiscount']);?></span>
										</div>
									</div>
									...
									<div class="col-sm-6">
										<div class="favorite-button m-t-10">
											<a class="btn btn-primarys"  style="color: white !important;" data-toggle="tooltip" data-placement="right" title="Wishlist" href="product-details.php?pid=<?php echo htmlentities($row['id'])?>&&action=wishlist">
							...
							<div class="quantity-container info-container">
								<div class="row">
									...
									<div class="col-sm-2">
										<span class="label" style="color: purple !important;">Qty :</span>
									</div>
									...
									<div class="col-sm-7">
<?php if($row['productAvailability']=='In Stock'){?>
										<a href="product-details.php?page=product&action=add&id=<?php echo $row['id']; ?>" class="btn btn-primarys" style="color: white !important;"><i class="fa fa-shopping-cart inner-right-vs" style="color: white !important;"></i> ADD TO CART</a>
													<?php } else {?>
			...
			.btn-primarys{
				background: linear-gradient(90deg, rgba(175,0,255,1) 0%, rgba(255,0,131,1) 100%);
							...
							<div class="product-social-link m-t-20 text-right"  style="color: purple !important;">
								<span class="social-label">Share :</span>
								<div class="social-icons" >
						            <ul class="list-inline"  style="color: purple !important; ">
					...
					<div class="row">
						<div class="col-sm-3">
							<ul id="product-tabs" class="nav nav-tabs nav-tab-cell" >
								<li class="active"><a data-toggle="tab" href="#description" style="background: linear-gradient(90deg, rgba(175,0,255,1) 0%, rgba(255,0,131,1) 100%);
">DESCRIPTION</a></li>
								<li><a data-toggle="tab" href="#review" style="background: linear-gradient(90deg, rgba(175,0,255,1) 0%, rgba(255,0,131,1) 100%);
">REVIEW</a></li>
						...
						<div class="col-sm-9">
							...
							<div class="tab-content" >
								...
								<div id="description" class="tab-pane in active">
									<div class="product-tab"  style="color:purple;">
...
<textarea class="form-control txt txt-review" id="exampleInputReview" rows="4" placeholder="" name="review" required="required"></textarea>
														...
														<div class="action text-right">
															<button name="submit" class="btn btn-primarys btn-upper" style="color: white !important;">SUBMIT REVIEW</button>
														</div><!-- /.action -->
...
while($rw=mysqli_fetch_array($qry))
{
	...
	<div class="product">		
		...
		<div class="product-info text-left">
			<h3 class="name"><a style="color:purple !important; font-size:20px; font-family:'K2D'" href="product-details.php?pid=<?php echo htmlentities($rw['id']);?>"><?php echo htmlentities($rw['productName']);?></a></h3>
			<div class="rating rateit-small"></div>
			...
			<div class="product-price">	
				...
				<div class="action">
					<ul class="list-unstyled" >
						...
						<a href="product-details.php?page=product&action=add&id=<?php echo $rw['id']; ?>" class="lnk btn btn-primarys" style="color: white !important;">Add to cart</a>
