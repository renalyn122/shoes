...
<div class="side-menu animate-dropdown outer-bottom-xs" style="width:150%; margin-left: -50%;">
    ...
    <nav class="yamm megamenu-horizontal" role="navigation">
        ...
        <ul class="nav">
            <li class="dropdown menu-item " style="color:white !important; background: linear-gradient(90deg, rgba(123,0,199,1) 0%, rgba(255,0,151,1) 100%) !important;">
...
<!-- ============================================== COLOR: END ============================================== -->
	...
	<div id="category" class="category-carousel hidden-xs">
		<div class="item">	
			<div class="image">
				<img src="assets/images/banners/cat-banner1.png" alt="" class="img-responsive">
			</div>
...
while($row=mysqli_fetch_array($sql))
{
    ?>
					...
					<div class="excerpt hidden-sm hidden-md" style="margin-top: 20px; margin-left:200px; color: black;">
