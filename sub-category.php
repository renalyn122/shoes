	...
	<div class='container'>
		<div class='row outer-bottom-sm'>
			<div class='col-md-3 sidebar'>
	            <!-- ================================== TOP NAVIGATION ================================== -->
<!-- ================================== TOP NAVIGATION : END ================================== -->	            <div class="sidebar-module-container"style="width:150%; margin-left: -50%;">
	            	<h3 class="section-title" >shop by</h3>
	            	<div class="sidebar-filter" >
		            	<!-- ============================================== SIDEBAR CATEGORY ============================================== -->
<div class="sidebar-widget wow fadeInUp outer-bottom-xs " >
	<div class="widget-header m-t-20" style="width:150%;  color:white; background-color:purple;">
...
<!-- ============================================== COLOR: END ============================================== -->
	...
	<div id="category" class="category-carousel hidden-xs">
		<div class="item">	
			<div class="image">
				<img src="assets/images/banners/cat-banner2.png" alt="" class="img-responsive">
			</div>
...
while($row=mysqli_fetch_array($sql))
{
    ?>
					...
					<div class="excerpt hidden-sm hidden-md"  style="margin-top: 20px; margin-left:130px; color: black;">
...
{?>							
	...
	<div class="product">		
		...
		<div class="product-info text-left" style="color: #c700fc !important;">
				...
				<div class="action">
					<ul class="list-unstyled">
						...
						<?php if($row['productAvailability']=='In Stock'){?>
							...
							<button class="btn btn-primarys" style="color: white !important;"type="button">Add to cart</button></a>
								<?php } else {?>
